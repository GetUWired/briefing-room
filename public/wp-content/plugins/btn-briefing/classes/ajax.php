...
final class btn_briefing_ajax  {
		...
		function btn_briefing_assigned_training_report_popup_action(){
			...
			else if($data_action == "not-completed"){
		...
		function btn_briefing_policy_delete_gform_action() {
		...
		function btn_briefing_policy_delete_action() {
			global $wpdb;
		...
		function btn_briefing_agency_policy_action() {
			global $wpdb;
			$user_id = get_current_user_id();
			$agency_id = btn_briefing()->frontend()->get_agency_id_by_user_id_manager($user_id);
		...
		function btn_briefing_hide_action(){
		...
		function btn_briefing_complete_action(){
		   check_ajax_referer('btn-briefing-ajax', 'nonce');
		   $user_id = get_current_user_id();
		...
		function btn_briefing_remove_to_favorite_action(){
			$user_id = get_current_user_id();
			$post_id = ( !empty($_POST['post_id']) ) ? $_POST['post_id'] : false;
		...
		function btn_briefing_add_to_favorite_action(){
			$user_id = get_current_user_id();
	 	   $post_id = ( !empty($_POST['post_id']) ) ? $_POST['post_id'] : false;
	 	   $personalize = get_user_meta($user_id, 'btn-briefing-favorite', true);
	   ...
	   function btn_briefing_assigned_training_report_action(){

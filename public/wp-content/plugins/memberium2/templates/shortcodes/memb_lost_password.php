...
echo '<p class="memb_lost_password_submitted">',
 _x('Your lost password request has been submitted.  Please check your email.', 'memb_lost_password', 'memberium'), '</p>';
}
?><form name="<?php echo $data->form_name;
 ?>" id="<?php echo $data->form_name; ?>" method="post">
 ...
 ?>">
	...
	<p>
		<label for="user_login"><?php echo $data->email_label;
 ?><br />

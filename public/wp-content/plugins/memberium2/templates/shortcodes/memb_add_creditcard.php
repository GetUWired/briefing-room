...
$label_street_address = _x('Street Address:',
 $name, $domain);
$label_submit = _x('Submit', $name, $domain);
$placeholder_address1 = _x('Address Line 1', $name, $domain);
$placeholder_address2 = _x('Optional Address Line 2',
 $name, $domain);

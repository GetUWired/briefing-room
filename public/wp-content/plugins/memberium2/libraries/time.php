...
final class m4is_m822t8xyvbc {
static function m4is_wfhqbdkz3e4fq() : array {
return [
...
'Pacific/Gambier' => '(GMT -09:00) Gambier</option>',
...
'Europe/London' => '(GMT) Dublin, Edinburgh, London',
'Africa/Lagos' => '(GMT +01:00) West Central Africa',
'Europe/Berlin' => '(GMT +01:00) Amsterdam, Berlin, Paris',
...
'Asia/Shanghai' => '(GMT +08:00) Manila, Perth, Shanghai',
...
static function m4is_yqqz5bfrwv2vy5hnwg7nj4xgqravc8ac( string $m4is_8mvynh0z8k8hwwt5r7azzzv308sgw ) : int {
$m4is_w1bvy4hbpp2ztcrgnvjjsp6rqd5gf78z = strtotime( $m4is_8mvynh0z8k8hwwt5r7azzzv308sgw );

if ( $m4is_w1bvy4hbpp2ztcrgnvjjsp6rqd5gf78z > time() ) {
$m4is_6rhmpghgr5p8zv6q = ( $m4is_w1bvy4hbpp2ztcrgnvjjsp6rqd5gf78z - time() ) / 86400;

}
else {
$m4is_6rhmpghgr5p8zv6q = 0 - ( (time() - $m4is_w1bvy4hbpp2ztcrgnvjjsp6rqd5gf78z) / 86400);
}
return (int) $m4is_6rhmpghgr5p8zv6q;

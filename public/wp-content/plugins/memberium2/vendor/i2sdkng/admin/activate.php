...
if ( ! function_exists( 'wpal_i2sdk_generate_key' ) ) {
function wpal_i2sdk_generate_key( int $length = 12 ) : string {
$length = max( 8,
 min( 24, $length ) );
...
$i2sdk_options['version'] = m4is_a6kbph84cyre1t461::VERSION;

update_option('i2sdk', $i2sdk_options, 'yes');
require_once ABSPATH . 'wp-admin/includes/upgrade.php';

$table_name = m4is_a6kbph84cyre1t461::DB_API_LOG;
...
dbDelta( $sql );
$table_name = m4is_a6kbph84cyre1t461::DB_DATAFORMFIELDS;
$sql = "CREATE TABLE {$table_name} (
		id int(11) NOT NULL,
		appname varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,

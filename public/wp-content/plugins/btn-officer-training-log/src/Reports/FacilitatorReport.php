...
class FacilitatorReport
{
    use Traits\HasDateRange;

    protected Sergeant $facilitator;

    public function __construct(Sergeant $facilitator)
    {
    ...
    public function csv(): string
    {
        ...
        $data = [
            ...
            ["Rank: {$this->facilitator->rank}", '', '', '',''],
            ["Facilitator First Name: {$this->facilitator->firstName}", '', '', '',''],
            ["Facilitator Last Name: {$this->facilitator->lastName}", '', '', '',''],
            ["Agency ID: {$this->facilitator->agencyId}", '', '', '',''],
            ["Badge ID: {$this->facilitator->badgeId}", '', '', '',''],
            ["State ID: {$this->facilitator->stateId}", '', '', '',''],
